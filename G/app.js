...
function renderListOfProduct() {
    ...
    for (let product of products) {
        let $product = $(`<div id="container">
                ...
                <div><button style="margin-bottom: 1em">See comment</button><div id="comment" hidden="hidden"><span><strong>Comment: </strong></span>${product.body}</div></div>
            </div>`);
